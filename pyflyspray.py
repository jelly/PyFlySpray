...
if __name__ == "__main__":
    ...
    Repo = ['Core','Testing','Community','Community-Testing','Extra','All']
    ...
    parser.add_argument('-s','--orphans', help='Fetch orphans from Archlinux or Community', choices=Repo, required=False)
    ...
    if args['unassigned']:
        ...
        orphans = (getorphans(args['orphans']))
